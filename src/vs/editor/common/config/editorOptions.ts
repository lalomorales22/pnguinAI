...
const DEFAULT_WINDOWS_FONT_FAMILY = '\'Comic Sans MS\', Consolas, \'Courier New\', monospace';
const DEFAULT_MAC_FONT_FAMILY = '\'Comic Sans MS\', Menlo, Monaco, \'Courier New\', monospace';
const DEFAULT_LINUX_FONT_FAMILY = '\'Comic Sans MS\', \'Droid Sans Mono\', \'monospace\', monospace';
